...
export type SpecialtyCard = {
  ...
  cardsSet?: {
    ...
    _type: "reference";
    _weak?: boolean;
    [internalGroqTypeReferenceTo]?: "specialtyCards";
  };
  tagLine?: string;
  title?: string;
  body?: Array<{
...
export type SpecialtyCards = {
  _id: string;
  _type: "specialtyCards";
  _createdAt: string;
  _updatedAt: string;
  _rev: string;
  cards?: Array<{
...
export type Doctor = {
  ...
  timezone?: "Asia/Kolkata" | "Asia/Dubai" | "Europe/London" | "America/New_York";
};
...
export type PAGE_QUERYResult = {
  blocks: Array<{
    ...
    stateMachines: Array<string> | null;
    defaultStateMachine: string | null;
    interactionInputs: Array<{
      inputName: string | null;
      inputType: "boolean" | "number" | "trigger" | null;
      event: "click" | "custom" | "hover" | "scroll" | null;
      value: number | null;
    }> | null;
  } | {
    _type: "hero-2";
